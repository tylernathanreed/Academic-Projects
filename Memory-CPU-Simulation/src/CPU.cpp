...
int CPU::getDebugMode()
{
	return this -> debugger -> getDebugMode();
}

// Sets the Current Debug Mode
int CPU::setDebugMode(int debug_mode)
{
	return this -> debugger -> setDebugMode(debug_mode);
}

// Debugs to the Bash Console
void CPU::debug(int access, string message)
{
	this -> debugger -> debug(access, message);
}
